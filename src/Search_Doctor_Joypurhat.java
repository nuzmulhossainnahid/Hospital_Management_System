 ...
 */
public class Search_Doctor_Joypurhat extends javax.swing.JFrame {

    /**
     * Creates new form Search_Doctor_Joypurhat
     */
    public Search_Doctor_Joypurhat() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Search_Doctor_Joypurhat");

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel1.setText("List of Doctor Joypurhat Dist");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Search_Doctor_Joypurhat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Search_Doctor_Joypurhat().setVisible(true);
            }
        });
    }
